  ...
  <div class="mains  mt-5 ">
    ...
    <form id="regForm" action="handle_form.php" method="POST" target="_blank">
      ...
      <div id="step1" class="step  row g-3">
        ...
        <div class="col-12">
          <div class="form-floating mb-3">
            <input type="text" name="InputName" class="form-control invalid" value="<?php echo $name?>" id="InputName"
              placeholder="name">
        ...
        <div class="col-12">
          <div class="form-floating mb-3 test">
            <input type="text" class="form-control" value="<?php echo $username?>" id="InputUserName"
              name="InputUserName" placeholder="Password">
        ...
        <div class="col-12">
          <div class="form-floating mb-3">
            <input type="email" class="form-control" value="<?php echo $email?>" name="InputEmail" id="InputEmail"
      ...
      <div id="step2" class="step row g-3 " style="display: none;">
        ...
        <div class="col-12">
          <div class="form-floating mb-3">
            <input type="date" name="dob" class="form-control " id="dob" placeholder="name" value="<?php echo $dob?>">
        ...
        <div class="col-12">
          <div class="form-floating  mb-3">
            <input type="text" class="form-control" id="AccountHolderName" name="AccountHolderName"
              placeholder="AccountHolderName" value="<?php echo $AccountHolderName?>">
